...
if __name__ == '__main__':
    ...
    df_business = spark.read \
        ...
        .option("header", "true") \
        .json("wasb://owshq-hdinsight-spark@owshqspark.blob.core.windows.net/data/yelp_academic_dataset_business_*.json")
    ...
    df_user = spark.read \
        ...
        .option("inferSchema", "true") \
        .option("header", "true") \
        .json("wasb://owshq-hdinsight-spark@owshqspark.blob.core.windows.net/data/yelp_academic_dataset_user_*.json")
    ...
    df_review = spark.read \
        ...
        .option("inferSchema", "true") \
        .option("header", "true") \
        .json("wasb://owshq-hdinsight-spark@owshqspark.blob.core.windows.net/data/yelp_academic_dataset_review_*.json")
