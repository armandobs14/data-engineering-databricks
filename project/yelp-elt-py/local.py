...
if __name__ == '__main__':
    ...
    df_business = spark.read \
        ...
        .option("header", "true") \
        .json("/Users/luanmorenomaciel/BitBucket/databricks/project/yelp-elt-py/yelp_academic_dataset_business.json")
    ...
    df_user = spark.read \
        ...
        .option("inferSchema", "true") \
        .option("header", "true") \
        .json("/Users/luanmorenomaciel/BitBucket/databricks/project/yelp-elt-py/yelp_academic_dataset_user.json")
    ...
    df_review = spark.read \
        ...
        .option("inferSchema", "true") \
        .option("header", "true") \
        .json("/Users/luanmorenomaciel/BitBucket/databricks/project/yelp-elt-py/yelp_academic_dataset_review.json")
